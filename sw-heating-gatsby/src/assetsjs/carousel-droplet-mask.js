...
const CarouselDropletMask = ({ height = '80vh', className, navBarHeight, style, click }) => {
  return (
    <S.CarouselDropletMask navBarHeight={navBarHeight} style={style} >
      ...
      >
        ...
        <S.Image xlinkHref={require("../images/image1.jpg")} alt={'To come'} className="clip-svg" />
      </svg>
      <S.DropletBorderSVG onClick={click} height={height} className={className} viewBox="0 0 476 588" fill="none">
    ...
    </S.CarouselDropletMask>
  )
}

const AnimCarouselDropletMask = animated.div

const S = {
  CarouselDropletMask: styled(AnimCarouselDropletMask)`
    position: relative;
    right: -3.75vw;
    width: 476px;
    width: 44%;
...
export default CarouselDropletMask
