...
const pages = [
  ({ style, navBarHeight, className, height, click }) => (
    <StyledMaskContainer navBarHeight={navBarHeight} style={style} >
      ...
      <StyledDropletBorderSVG onClick={click} height={height} className={className} viewBox="0 0 476 588" fill="none">
  ...
  return (
    <StyledDropletImageMaskContainer navBarHeight={navBarHeight} >
      ...
      {transitions.map(({ item, props, key }) => {
        ...
        return <Page key={key} click={onClick} style={props} height={height} className={className} navBarHeight={navBarHeight} />
      })}
      <ButtonssContainer>
        <Button onClick={onClick} className={index === 0 && 'active'} />
        <Button onClick={onClick} className={index === 1 && 'active'} />
        <Button onClick={onClick} className={index === 2 && 'active'} />
        <Button onClick={onClick} className={index === 3 && 'active'} />
        <Button onClick={onClick} className={index === 4 && 'active'} />
...
const ButtonssContainer = styled.div`
  position: absolute;
  right: 0;
  bottom: 0;
  z-index: 99999;
